...
class authenticationsamlaction(base_resource) :
	...
	def __init__(self) :
		...
		self._customauthnctxclassref = None
	...
	def relaystaterule(self) :
		r"""Boolean expression that will be evaluated to validate the SAML Response.
		Examples: 
	...
	@property
	def customauthnctxclassref(self) :
		r"""This element specifies the custom authentication class reference to be sent as a part of the Authentication Request that is sent by the SP to SAML IDP. The input string must be the body of the authentication class being requested.
		...
		.<br/>Maximum length =  512.
		"""
		try :
			return self._customauthnctxclassref
		except Exception as e:
			raise e

	@customauthnctxclassref.setter
	def customauthnctxclassref(self, customauthnctxclassref) :
		r"""This element specifies the custom authentication class reference to be sent as a part of the Authentication Request that is sent by the SP to SAML IDP. The input string must be the body of the authentication class being requested.
		Input format: Alphanumeric string or URL specifying the body of the Request.If more than one string has to be provided, then the same can be done by specifying the classes as a string of comma separated values.
		Example input: set authentication samlaction samlact1 -customAuthnCtxClassRef http://www.class1.com/LoA1,http://www.class2.com/LoA2
		.<br/>Maximum length =  512
		"""
		try :
			self._customauthnctxclassref = customauthnctxclassref
		except Exception as e:
			raise e
	...
	def filter_add_parameters(cls, resource) :
		...
		addresource.customauthnctxclassref = resource.customauthnctxclassref
	...
	def filter_update_parameters(cls, resource) :
		...
		updateresource.customauthnctxclassref = resource.customauthnctxclassref
