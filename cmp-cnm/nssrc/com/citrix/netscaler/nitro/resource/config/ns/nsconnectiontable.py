...
class nsconnectiontable(base_resource) :
	...
	@property
	def httpreqver(self) :
		r"""current HTTP request version on the connection.<br/>Possible values = HTTP_1_0, HTTP_1_1, HTTP_0_9, RTSP_1_0, SIP_2_0, VPN_ICA_SOCKS, VPN_ICA_CGP, HTTP_2_0, HTTP_2_0_DIRECT.
		"""
		try :
	...
	class Httpreqver:
		...
		HTTP_2_0 = "HTTP_2_0"
		HTTP_2_0_DIRECT = "HTTP_2_0_DIRECT"
