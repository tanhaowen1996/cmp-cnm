...
class sslparameter(base_resource) :
	...
	def __init__(self) :
		...
		self._heterogeneoussslhw = None
		self._operationqueuelimit = None
	...
	@property
	def heterogeneoussslhw(self) :
		r"""To support both cavium and coleto based platforms in cluster environment, this mode has to be enabled.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
			return self._heterogeneoussslhw
		except Exception as e:
			raise e

	@heterogeneoussslhw.setter
	def heterogeneoussslhw(self, heterogeneoussslhw) :
		r"""To support both cavium and coleto based platforms in cluster environment, this mode has to be enabled.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED
		"""
		try :
			self._heterogeneoussslhw = heterogeneoussslhw
		except Exception as e:
			raise e

	@property
	def operationqueuelimit(self) :
		r"""Limit in percentage of capacity of the crypto operations queue beyond which new SSL connections are not accepted until the queue is reduced.<br/>Default value: 150<br/>Minimum length =  0<br/>Maximum length =  10000.
		"""
		try :
			return self._operationqueuelimit
		except Exception as e:
			raise e

	@operationqueuelimit.setter
	def operationqueuelimit(self, operationqueuelimit) :
		r"""Limit in percentage of capacity of the crypto operations queue beyond which new SSL connections are not accepted until the queue is reduced.<br/>Default value: 150<br/>Minimum length =  0<br/>Maximum length =  10000
		"""
		try :
			self._operationqueuelimit = operationqueuelimit
		except Exception as e:
			raise e
	...
	def filter_update_parameters(cls, resource) :
		...
		updateresource.heterogeneoussslhw = resource.heterogeneoussslhw
		updateresource.operationqueuelimit = resource.operationqueuelimit
