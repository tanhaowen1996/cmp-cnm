...
class sslvserver(base_resource) :
	...
	@property
	def dhcount(self) :
		r"""Number of interactions, between the client and the Citrix ADC, after which the DH private-public pair is regenerated. A value of zero (0) specifies refresh every time.<br/>Maximum length =  65534.
		"""
		try :
	...
	@property
	def ssl3(self) :
		r"""State of SSLv3 protocol support for the SSL Virtual Server.
	...
	@property
	def dtls1(self) :
		r"""State of DTLSv1.0 protocol support for the SSL Virtual Server.<br/>Default value: ENABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
			return self._dtls1
		except Exception as e:
	...
	@property
	def dtls12(self) :
		r"""State of DTLSv1.2 protocol support for the SSL Virtual Server.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
			return self._dtls12
		except Exception as e:
