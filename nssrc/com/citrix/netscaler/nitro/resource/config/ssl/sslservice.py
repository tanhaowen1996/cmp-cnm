...
class sslservice(base_resource) :
	...
	@property
	def dhcount(self) :
		r"""Number of interactions, between the client and the Citrix ADC, after which the DH private-public pair is regenerated. A value of zero (0) specifies refresh every time. This parameter is not applicable when configuring a backend service. Allowed DH count values are 0 and >= 500.<br/>Maximum length =  65534.
		"""
		try :
	...
	@property
	def ssl3(self) :
		r"""State of SSLv3 protocol support for the SSL service.
		Note: On platforms with SSL acceleration chips, if the SSL chip does not support SSLv3, this parameter cannot be set to ENABLED.<br/>Default value: ENABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
			return self._ssl3
		except Exception as e:
	...
	@property
	def dtls1(self) :
		r"""State of DTLSv1.0 protocol support for the SSL service.<br/>Default value: ENABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
			return self._dtls1
		except Exception as e:
	...
	@property
	def dtls12(self) :
		r"""State of DTLSv1.2 protocol support for the SSL service.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
			return self._dtls12
		except Exception as e:
	...
	def filter_update_parameters(cls, resource) :
		...
		updateresource.dtls1 = resource.dtls1
		updateresource.dtls12 = resource.dtls12
