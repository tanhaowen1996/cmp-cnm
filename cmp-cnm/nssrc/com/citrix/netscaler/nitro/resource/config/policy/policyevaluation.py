...
class policyevaluation(base_resource) :
	...
	def __init__(self) :
		...
		self._pitoffsetnewlengtharray = None
	...
	def pitoffsetlengtharray(self) :
		r"""Details of the lengths of the data which Citrix ADC modified or deleted during applying of rewrite action.
		"""
		try :
	...
	@property
	def pitoffsetnewlengtharray(self) :
		r"""Details of the lengths of the data which Citrix ADC either inserted or modified during applying of rewrite action.
		"""
		try :
			return self._pitoffsetnewlengtharray
		except Exception as e:
			raise e
