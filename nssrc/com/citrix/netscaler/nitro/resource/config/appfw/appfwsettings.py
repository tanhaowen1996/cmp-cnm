...
class appfwsettings(base_resource) :
	...
	def __init__(self) :
		...
		self._centralizedlearning = None
	...
	@property
	def centralizedlearning(self) :
		r"""Flag used to enable/disable ADM centralized learning.<br/>Default value: OFF<br/>Possible values = ON, OFF.
		"""
		try :
			return self._centralizedlearning
		except Exception as e:
			raise e

	@centralizedlearning.setter
	def centralizedlearning(self, centralizedlearning) :
		r"""Flag used to enable/disable ADM centralized learning.<br/>Default value: OFF<br/>Possible values = ON, OFF
		"""
		try :
			self._centralizedlearning = centralizedlearning
		except Exception as e:
			raise e
	...
	@property
	def learning(self) :
		r"""Global learning option that overrides the profile level learning.
		Available settings are as follows:
		* ON  - Honor all profile level learn settings.
		* OFF - Avoids learning for all profiles ignoring profile level learn setting.<br/>Default value: ON<br/>Possible values = ON, OFF.
		"""
		try :
	...
	def filter_update_parameters(cls, resource) :
		...
		updateresource.centralizedlearning = resource.centralizedlearning
