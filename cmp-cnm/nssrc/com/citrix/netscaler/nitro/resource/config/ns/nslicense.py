...
class nslicense(base_resource) :
	...
	def __init__(self) :
		...
		self._cloudsubscriptionimage = None
	...
	@property
	def cloudsubscriptionimage(self) :
		r"""Cloud Subscription Image.<br/>Default value: NO<br/>Possible values = YES, NO.
		"""
		try :
			return self._cloudsubscriptionimage
		except Exception as e:
			raise e
