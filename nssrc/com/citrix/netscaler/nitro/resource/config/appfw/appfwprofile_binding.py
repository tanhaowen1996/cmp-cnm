...
class appfwprofile_binding(base_resource):
	...
	@property
	def appfwprofile_jsoncmdurl_bindings(self) :
		r"""jsoncmdurl that can be bound to appfwprofile.
		"""
		try :
			return self._appfwprofile_jsoncmdurl_binding
		except Exception as e:
			raise e

	@property
	def appfwprofile_cmdinjection_bindings(self) :
		r"""cmdinjection that can be bound to appfwprofile.
		"""
		try :
			return self._appfwprofile_cmdinjection_binding
		except Exception as e:
			raise e
