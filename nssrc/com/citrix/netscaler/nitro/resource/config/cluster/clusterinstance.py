...
class clusterinstance(base_resource) :
	...
	def __init__(self) :
		...
		self._backplanebasedview = None
		self._syncstatusstrictmode = None
	...
	@property
	def backplanebasedview(self) :
		r"""View based on heartbeat only on bkplane interface.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
			return self._backplanebasedview
		except Exception as e:
			raise e

	@backplanebasedview.setter
	def backplanebasedview(self, backplanebasedview) :
		r"""View based on heartbeat only on bkplane interface.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED
		"""
		try :
			self._backplanebasedview = backplanebasedview
		except Exception as e:
			raise e

	@property
	def syncstatusstrictmode(self) :
		r"""strict mode for sync status of cluster. Depending on the the mode if there are any errors while applying config, sync status is displayed accordingly. By default the flag is disabled.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
			return self._syncstatusstrictmode
		except Exception as e:
			raise e

	@syncstatusstrictmode.setter
	def syncstatusstrictmode(self, syncstatusstrictmode) :
		r"""strict mode for sync status of cluster. Depending on the the mode if there are any errors while applying config, sync status is displayed accordingly. By default the flag is disabled.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED
		"""
		try :
			self._syncstatusstrictmode = syncstatusstrictmode
		except Exception as e:
			raise e
	...
	def filter_add_parameters(cls, resource) :
		...
		addresource.backplanebasedview = resource.backplanebasedview
		addresource.syncstatusstrictmode = resource.syncstatusstrictmode
		return addresource
	...
	def filter_update_parameters(cls, resource) :
		...
		updateresource.backplanebasedview = resource.backplanebasedview
		updateresource.syncstatusstrictmode = resource.syncstatusstrictmode
