    ...
    def create(self, request, *args, **kwargs):
        try:
            ...
            serializer.save(
                ...
                source_tenant_id=request.data['source_tenant_id'],
                source_tenant_name=request.data['source_tenant_name'],
                source_network=request.data['source_network'],
                destination_tenant_id=request.data['destination_tenant_id'],
                destination_tenant_name=request.data['destination_tenant_name'],
