...
class appfwpolicylabel(base_resource) :
	...
	def policylabeltype(self) :
		r"""Type of transformations allowed by the policies bound to the label. Always http_req for application firewall policy labels.<br/>Possible values = http_req, httpquic_req.
		"""
		try :
