...
class nstcpprofile(base_resource) :
	...
	def __init__(self) :
		...
		self._clientiptcpoption = None
		self._clientiptcpoptionnumber = None
		self._mpcapablecbit = None
		self._refcnt = None
		self._builtin = None
		self._feature = None
		self.___count = None
	...
	@property
	def clientiptcpoption(self) :
		r"""Client IP in TCP options.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
			return self._clientiptcpoption
		except Exception as e:
			raise e

	@clientiptcpoption.setter
	def clientiptcpoption(self, clientiptcpoption) :
		r"""Client IP in TCP options.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED
		"""
		try :
			self._clientiptcpoption = clientiptcpoption
		except Exception as e:
			raise e

	@property
	def clientiptcpoptionnumber(self) :
		r"""ClientIP TCP Option number.<br/>Minimum length =  1<br/>Maximum length =  254.
		"""
		try :
			return self._clientiptcpoptionnumber
		except Exception as e:
			raise e

	@clientiptcpoptionnumber.setter
	def clientiptcpoptionnumber(self, clientiptcpoptionnumber) :
		r"""ClientIP TCP Option number.<br/>Minimum length =  1<br/>Maximum length =  254
		"""
		try :
			self._clientiptcpoptionnumber = clientiptcpoptionnumber
		except Exception as e:
			raise e

	@property
	def mpcapablecbit(self) :
		r"""Set C bit in MP-CAPABLE Syn-Ack sent by Citrix ADC.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
			return self._mpcapablecbit
		except Exception as e:
			raise e

	@mpcapablecbit.setter
	def mpcapablecbit(self, mpcapablecbit) :
		r"""Set C bit in MP-CAPABLE Syn-Ack sent by Citrix ADC.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED
		"""
		try :
			self._mpcapablecbit = mpcapablecbit
		except Exception as e:
			raise e
	...
	def filter_add_parameters(cls, resource) :
		...
		addresource.clientiptcpoption = resource.clientiptcpoption
		addresource.clientiptcpoptionnumber = resource.clientiptcpoptionnumber
		addresource.mpcapablecbit = resource.mpcapablecbit
		return addresource
	...
	def filter_update_parameters(cls, resource) :
		...
		updateresource.clientiptcpoption = resource.clientiptcpoption
		updateresource.clientiptcpoptionnumber = resource.clientiptcpoptionnumber
		updateresource.mpcapablecbit = resource.mpcapablecbit
