...
class dnsparameter(base_resource) :
	...
	def __init__(self) :
		...
		self._nxdomainratelimitthreshold = None
		self._builtin = None
		self._feature = None
		self._nxdomainthresholdcrossed = None
	...
	@property
	def nxdomainratelimitthreshold(self) :
		r"""Rate limit threshold for Non-Existant domain (NXDOMAIN) responses generated from Citrix ADC. Once the threshold is breached , DNS queries leading to NXDOMAIN response will be dropped. This threshold will not be applied for NXDOMAIN responses got from the backend. The threshold will be applied per packet engine and per second.
		"""
		try :
			return self._nxdomainratelimitthreshold
		except Exception as e:
			raise e

	@nxdomainratelimitthreshold.setter
	def nxdomainratelimitthreshold(self, nxdomainratelimitthreshold) :
		r"""Rate limit threshold for Non-Existant domain (NXDOMAIN) responses generated from Citrix ADC. Once the threshold is breached , DNS queries leading to NXDOMAIN response will be dropped. This threshold will not be applied for NXDOMAIN responses got from the backend. The threshold will be applied per packet engine and per second.
		"""
		try :
			self._nxdomainratelimitthreshold = nxdomainratelimitthreshold
		except Exception as e:
			raise e
	...
	@property
	def nxdomainthresholdcrossed(self) :
		r"""Number of times requests has been dropped as number of DNS queries leading to NXDOMAIN response has crossed the threshold.
		"""
		try :
			return self._nxdomainthresholdcrossed
		except Exception as e:
			raise e
	...
	def filter_update_parameters(cls, resource) :
		...
		updateresource.nxdomainratelimitthreshold = resource.nxdomainratelimitthreshold
