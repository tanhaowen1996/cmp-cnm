...
class cachepolicylabel(base_resource) :
	...
	@property
	def evaluates(self) :
		r"""When to evaluate policies bound to this label: request-time or response-time.<br/>Possible values = REQ, RES, MSSQL_REQ, MSSQL_RES, MYSQL_REQ, MYSQL_RES, HTTPQUIC_REQ, HTTPQUIC_RES.
		"""
		try :
