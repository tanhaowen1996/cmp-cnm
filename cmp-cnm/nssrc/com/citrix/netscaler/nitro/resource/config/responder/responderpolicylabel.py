...
class responderpolicylabel(base_resource) :
	...
	def policylabeltype(self) :
		...
		* MQTT_JUMBO - Trigger policies bind with MQTT Jumbo type.<br/>Default value: HTTP<br/>Possible values = HTTP, OTHERTCP, SIP_UDP, SIP_TCP, MYSQL, MSSQL, NAT, DIAMETER, RADIUS, DNS, MQTT, MQTT_JUMBO, QUIC_BRIDGE, HTTP_QUIC.
		"""
		try :
