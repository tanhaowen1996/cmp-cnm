...
class protocolhttp_stats(base_resource) :
	...
	def __init__(self) :
		...
		self._httperrrfc7230desynctlente = 0
		self._httperrrfc7230desynmultictlen = 0
		self._httperrrfc7230desynidenticalctlen = 0
	...
	@property
	def httperrrfc7230desynidenticalctlen(self) :
		r"""Total number of request/response received with duplicate content-length headers - RFC7230 Non-compliance.
		"""
		try :
			return self._httperrrfc7230desynidenticalctlen
		except Exception as e:
			raise e
	...
	@property
	def httperrrfc7230desynctlente(self) :
		r"""Total number of requests/responses received with both content-length and transfer encoding headers - RFC7230 Non-compliance.
		"""
		try :
			return self._httperrrfc7230desynctlente
		except Exception as e:
			raise e
	...
	@property
	def httperrrfc7230desynmultictlen(self) :
		r"""Total number of request/response received with multiple content-length headers with different values -  RFC7230 Non-compliance.
		"""
		try :
			return self._httperrrfc7230desynmultictlen
		except Exception as e:
			raise e
