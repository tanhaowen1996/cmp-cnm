...
class appfwprofile_stats(base_resource) :
	...
	def __init__(self) :
		...
		self._appfirewallpostbodylimitviolationsperprofile = 0
		self._appfirewallpostbodylimitviolationsperprofilerate = 0
		self._appfirewallviolcookieperprofile = 0
		self._appfirewallviolcookieperprofilerate = 0
		self._appfirewallviolcookiehijackperprofile = 0
		self._appfirewallviolcookiehijackperprofilerate = 0
		...
		self._appfirewallvioljsoncmdperprofile = 0
		self._appfirewallvioljsoncmdperprofilerate = 0
		self._appfirewallviolfileuploadtypesperprofile = 0
		self._appfirewallviolfileuploadtypesperprofilerate = 0
		self._appfirewallxmlpayloadcontenttypemismatchperprofile = 0
		self._appfirewallxmlpayloadcontenttypemismatchperprofilerate = 0
		self._appfirewallviolcmdperprofile = 0
		self._appfirewallviolcmdperprofilerate = 0
		...
		self._appfirewallviolsqlgramperprofile = 0
		self._appfirewallviolsqlgramperprofilerate = 0
		self._appfirewallvioljsonsqlgramperprofile = 0
		self._appfirewallvioljsonsqlgramperprofilerate = 0
		...
		self._appfirewallpostbodylimitlogsperprofile = 0
		self._appfirewallpostbodylimitlogsperprofilerate = 0
		self._appfirewalllogcookieperprofile = 0
		self._appfirewalllogcookieperprofilerate = 0
		self._appfirewalllogcookiehijackperprofile = 0
		self._appfirewalllogcookiehijackperprofilerate = 0
		...
		self._appfirewalllogsjsoncmdperprofile = 0
		self._appfirewalllogsjsoncmdperprofilerate = 0
		self._appfirewalllogfileuploadtypesperprofile = 0
		self._appfirewalllogfileuploadtypesperprofilerate = 0
		self._appfirewallloginfercontenttypexmlpayloadperprofile = 0
		self._appfirewallloginfercontenttypexmlpayloadperprofilerate = 0
		self._appfirewalllogcmdperprofile = 0
		self._appfirewalllogcmdperprofilerate = 0
		...
		self._appfirewalllogsqlgramperprofile = 0
		self._appfirewalllogsqlgramperprofilerate = 0
		self._appfirewalllogsjsonsqlgramperprofile = 0
		self._appfirewalllogsjsonsqlgramperprofilerate = 0
	...
	@property
	def appfirewallpostbodylimitlogsperprofile(self) :
		r"""Number of Post Body Limit security check logs seen by the Application Firewall.
		"""
		try :
			return self._appfirewallpostbodylimitlogsperprofile
		except Exception as e:
			raise e
	...
	@property
	def appfirewalllogcmdperprofilerate(self) :
		r"""Rate (/s) counter for appfirewalllogcmdperprofile.
		"""
		try :
			return self._appfirewalllogcmdperprofilerate
		except Exception as e:
			raise e
	...
	@property
	def appfirewallvioljsonsqlgramperprofile(self) :
		r"""Number of JSON SQL Injection security check violations (reported by SQL grammar) seen by the Application Firewall.
		"""
		try :
			return self._appfirewallvioljsonsqlgramperprofile
		except Exception as e:
			raise e

	@property
	def appfirewallvioljsonsqlgramperprofilerate(self) :
		r"""Rate (/s) counter for appfirewallvioljsonsqlgramperprofile.
		"""
		try :
			return self._appfirewallvioljsonsqlgramperprofilerate
		except Exception as e:
			raise e

	@property
	def appfirewalllogcookiehijackperprofilerate(self) :
		r"""Rate (/s) counter for appfirewalllogcookiehijackperprofile.
		"""
		try :
			return self._appfirewalllogcookiehijackperprofilerate
		except Exception as e:
			raise e

	@property
	def appfirewallloginfercontenttypexmlpayloadperprofilerate(self) :
		r"""Rate (/s) counter for appfirewallloginfercontenttypexmlpayloadperprofile.
		"""
		try :
			return self._appfirewallloginfercontenttypexmlpayloadperprofilerate
		except Exception as e:
			raise e
	...
	@property
	def appfirewallxmlpayloadcontenttypemismatchperprofilerate(self) :
		r"""Rate (/s) counter for appfirewallxmlpayloadcontenttypemismatchperprofile.
		"""
		try :
			return self._appfirewallxmlpayloadcontenttypemismatchperprofilerate
		except Exception as e:
			raise e
	...
	@property
	def appfirewallxmlpayloadcontenttypemismatchperprofile(self) :
		...
		"""
		try :
			return self._appfirewallxmlpayloadcontenttypemismatchperprofile
		except Exception as e:
			raise e
	...
	@property
	def appfirewallpostbodylimitviolationsperprofilerate(self) :
		r"""Rate (/s) counter for appfirewallpostbodylimitviolationsperprofile.
		"""
		try :
			return self._appfirewallpostbodylimitviolationsperprofilerate
		except Exception as e:
			raise e

	@property
	def appfirewalllogsjsonsqlgramperprofile(self) :
		r"""Number of JSON SQL Injection security check log messages (reported by SQL grammar) generated by the Application Firewall.
		"""
		try :
			return self._appfirewalllogsjsonsqlgramperprofile
		except Exception as e:
			raise e
	...
	@property
	def appfirewallviolcookiehijackperprofile(self) :
		r"""Number of Cookie Hijacking security violations seen by the Application Firewall.
		"""
		try :
			return self._appfirewallviolcookiehijackperprofile
		except Exception as e:
			raise e
	...
	@property
	def appfirewalllogsjsoncmdperprofile(self) :
		r"""Number of JSON Command Injection security check log messages generated by the Application Firewall.
		"""
		try :
			return self._appfirewalllogsjsoncmdperprofile
		except Exception as e:
			raise e

	@property
	def appfirewallviolsqlgramperprofilerate(self) :
		r"""Rate (/s) counter for appfirewallviolsqlgramperprofile.
		"""
		try :
			return self._appfirewallviolsqlgramperprofilerate
		except Exception as e:
			raise e
	...
	@property
	def appfirewallpostbodylimitlogsperprofilerate(self) :
		r"""Rate (/s) counter for appfirewallpostbodylimitlogsperprofile.
		"""
		try :
			return self._appfirewallpostbodylimitlogsperprofilerate
		except Exception as e:
			raise e
	...
	@property
	def appfirewalllogsqlgramperprofilerate(self) :
		r"""Rate (/s) counter for appfirewalllogsqlgramperprofile.
		"""
		try :
			return self._appfirewalllogsqlgramperprofilerate
		except Exception as e:
			raise e
	...
	@property
	def appfirewallloginfercontenttypexmlpayloadperprofile(self) :
		r"""Number of Mismatched Content-Type in request with XML Payload security check logs seen by the Application Firewall.
		"""
		try :
			return self._appfirewallloginfercontenttypexmlpayloadperprofile
		except Exception as e:
			raise e
	...
	@property
	def appfirewallviolsqlgramperprofile(self) :
		r"""Number of HTML SQL Injection security check violations (reported by SQL grammar) seen by the Application Firewall.
		"""
		try :
			return self._appfirewallviolsqlgramperprofile
		except Exception as e:
			raise e
	...
	@property
	def appfirewallvioljsoncmdperprofilerate(self) :
		r"""Rate (/s) counter for appfirewallvioljsoncmdperprofile.
		"""
		try :
			return self._appfirewallvioljsoncmdperprofilerate
		except Exception as e:
			raise e
	...
	@property
	def appfirewalllogsjsonsqlgramperprofilerate(self) :
		r"""Rate (/s) counter for appfirewalllogsjsonsqlgramperprofile.
		"""
		try :
			return self._appfirewalllogsjsonsqlgramperprofilerate
		except Exception as e:
			raise e
	...
	@property
	def appfirewallviolcmdperprofilerate(self) :
		r"""Rate (/s) counter for appfirewallviolcmdperprofile.
		"""
		try :
			return self._appfirewallviolcmdperprofilerate
		except Exception as e:
			raise e
	...
	@property
	def appfirewalllogsjsoncmdperprofilerate(self) :
		r"""Rate (/s) counter for appfirewalllogsjsoncmdperprofile.
		"""
		try :
			return self._appfirewalllogsjsoncmdperprofilerate
		except Exception as e:
			raise e
	...
	@property
	def appfirewallviolcookiehijackperprofilerate(self) :
		r"""Rate (/s) counter for appfirewallviolcookiehijackperprofile.
		"""
		try :
			return self._appfirewallviolcookiehijackperprofilerate
		except Exception as e:
			raise e
	...
	@property
	def appfirewallviolcmdperprofile(self) :
		r"""Number of HTML Command Injection security check violations seen by the Application Firewall.
		"""
		try :
			return self._appfirewallviolcmdperprofile
		except Exception as e:
			raise e
	...
	@property
	def appfirewallpostbodylimitviolationsperprofile(self) :
		r"""Number of Post Body Limit security check violations seen by the Application Firewall.
		"""
		try :
			return self._appfirewallpostbodylimitviolationsperprofile
		except Exception as e:
			raise e
