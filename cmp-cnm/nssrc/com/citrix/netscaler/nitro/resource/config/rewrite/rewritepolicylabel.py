...
class rewritepolicylabel(base_resource) :
	...
	def transform(self) :
		...
		* dns_res - DNS responses.<br/>Possible values = http_req, http_res, othertcp_req, othertcp_res, url, text, clientless_vpn_req, clientless_vpn_res, sipudp_req, sipudp_res, siptcp_req, siptcp_res, diameter_req, diameter_res, radius_req, radius_res, dns_req, dns_res, httpquic_req, httpquic_res.
		"""
		try :
