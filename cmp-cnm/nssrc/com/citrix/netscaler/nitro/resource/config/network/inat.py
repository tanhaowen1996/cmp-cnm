...
class inat(base_resource) :
	...
	def connfailover(self) :
		r"""Synchronize connection information with the secondary appliance in a high availability (HA) pair. That is, synchronize all connection-related information for the INAT session.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
