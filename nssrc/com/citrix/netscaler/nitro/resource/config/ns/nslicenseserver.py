...
class nslicenseserver(base_resource) :
	...
	@property
	def forceupdateip(self) :
		r"""If this flag is used while adding the licenseserver, existing config will be overwritten. Use this flag only if you are sure that the new licenseserver has the required capacity.
		"""
		try :
			return self._forceupdateip
		except Exception as e:
			raise e

	@forceupdateip.setter
	def forceupdateip(self, forceupdateip) :
		r"""If this flag is used while adding the licenseserver, existing config will be overwritten. Use this flag only if you are sure that the new licenseserver has the required capacity.
		"""
		try :
			self._forceupdateip = forceupdateip
		except Exception as e:
			raise e
	...
	def filter_add_parameters(cls, resource) :
		...
		addresource.forceupdateip = resource.forceupdateip
		return addresource
