...
class l2param(base_resource) :
	...
	def __init__(self) :
		...
		self._usenetprofilebsdtraffic = None
	...
	@property
	def usenetprofilebsdtraffic(self) :
		r"""Control source parameters (IP and Port) for FreeBSD initiated traffic. If enabled proxy the source parameters based on netprofile source ip. If netprofile does not have ip configured, then it will continue to use NSIP as earlier.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
			return self._usenetprofilebsdtraffic
		except Exception as e:
			raise e

	@usenetprofilebsdtraffic.setter
	def usenetprofilebsdtraffic(self, usenetprofilebsdtraffic) :
		r"""Control source parameters (IP and Port) for FreeBSD initiated traffic. If enabled proxy the source parameters based on netprofile source ip. If netprofile does not have ip configured, then it will continue to use NSIP as earlier.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED
		"""
		try :
			self._usenetprofilebsdtraffic = usenetprofilebsdtraffic
		except Exception as e:
			raise e
	...
	def filter_update_parameters(cls, resource) :
		...
		updateresource.usenetprofilebsdtraffic = resource.usenetprofilebsdtraffic
