...
class transformpolicylabel(base_resource) :
	...
	def policylabeltype(self) :
		r"""Types of transformations allowed by the policies bound to the label. For URL transformation, always http_req (HTTP Request).<br/>Possible values = http_req, httpquic_req.
		"""
		try :
