...
class responderhtmlpage(base_resource) :
	...
	@property
	def cacertfile(self) :
		r"""CA certificate file name which will be used to verify the peer's certificate. The certificate should be imported using "import ssl certfile" CLI command or equivalent in API or GUI. If certificate name is not configured, then default root CA certificates are used for peer's certificate verification.
		"""
		try :
	...
	def Import(cls, client, resource) :
		...
		try :
			if type(resource) is not list :
				...
				Importresource.cacertfile = resource.cacertfile
