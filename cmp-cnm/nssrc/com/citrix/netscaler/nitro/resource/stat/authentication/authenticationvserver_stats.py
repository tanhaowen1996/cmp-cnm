...
class authenticationvserver_stats(base_resource) :
	...
	def cachepolicy(self) :
		r"""cachepolicy that are bound to authenticationvserver.
		"""
		try :
	...
	def rewritepolicy(self) :
		r"""rewritepolicy that are bound to authenticationvserver.
		"""
		try :
	...
	def responderpolicy(self) :
		r"""responderpolicy that are bound to authenticationvserver.
		"""
		try :
