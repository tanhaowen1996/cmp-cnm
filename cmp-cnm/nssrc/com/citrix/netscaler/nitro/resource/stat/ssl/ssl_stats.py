...
class ssl_stats(base_resource) :
	def __init__(self) :
		...
		self._sslcryptoutilizationsymmstat = 0
		self._sslcryptoutilizationasymstat = 0
		...
		self._ssltotdtlsv12transactions = 0
		self._ssldtlsv12transactionsrate = 0
		...
		self._ssltotdtlsv12sessions = 0
		self._ssldtlsv12sessionsrate = 0
		...
		self._ssltotdtlsv12renegsessions = 0
		self._ssldtlsv12renegsessionsrate = 0
		...
		self._ssltotecdhetransactions = 0
		self._sslecdhetransactionsrate = 0
		...
		self._ssltotdtlsv12handshakes = 0
		self._ssldtlsv12handshakesrate = 0
		...
		self._ssltotdtlsv12clientauthentications = 0
		self._ssldtlsv12clientauthenticationsrate = 0
	...
	@property
	def ssltotdtlsv12transactions(self) :
		r"""Number of DTLSv1.2 transactions on the Citrix ADC.
		"""
		try :
			return self._ssltotdtlsv12transactions
		except Exception as e:
			raise e
	...
	@property
	def ssldtlsv12sessionsrate(self) :
		r"""Rate (/s) counter for ssltotdtlsv12sessions.
		"""
		try :
			return self._ssldtlsv12sessionsrate
		except Exception as e:
			raise e
	...
	@property
	def ssldtlsv12handshakesrate(self) :
		r"""Rate (/s) counter for ssltotdtlsv12handshakes.
		"""
		try :
			return self._ssldtlsv12handshakesrate
		except Exception as e:
			raise e
	...
	@property
	def sslcryptoutilizationsymmstat(self) :
		r"""Utilization of the hardware symmetric crypto resource. Only valid values are 0-100%. Only works on platforms with Intel crypto chips.
		"""
		try :
			return self._sslcryptoutilizationsymmstat
		except Exception as e:
			raise e
	...
	@property
	def ssldtlsv12renegsessionsrate(self) :
		r"""Rate (/s) counter for ssltotdtlsv12renegsessions.
		"""
		try :
			return self._ssldtlsv12renegsessionsrate
		except Exception as e:
			raise e
	...
	@property
	def ssltotdtlsv12clientauthentications(self) :
		r"""Number of client authentications done on DTLSv1.2.
		"""
		try :
			return self._ssltotdtlsv12clientauthentications
		except Exception as e:
			raise e
	...
	@property
	def ssltotdtlsv12handshakes(self) :
		r"""Number of SSL handshakes on DTLSv1.2 on the Citrix ADC.
		"""
		try :
			return self._ssltotdtlsv12handshakes
		except Exception as e:
			raise e
	...
	@property
	def ssltotdtlsv12sessions(self) :
		r"""Number of DTLSv1.2 sessions on the Citrix ADC.
		"""
		try :
			return self._ssltotdtlsv12sessions
		except Exception as e:
			raise e

	@property
	def ssltotdtlsv12renegsessions(self) :
		r"""Number of SSL session renegotiations done on DTLSv1.2.
		"""
		try :
			return self._ssltotdtlsv12renegsessions
		except Exception as e:
			raise e
	...
	@property
	def sslecdhetransactionsrate(self) :
		r"""Rate (/s) counter for ssltotecdhetransactions.
		"""
		try :
			return self._sslecdhetransactionsrate
		except Exception as e:
			raise e
	...
	@property
	def ssldtlsv12clientauthenticationsrate(self) :
		r"""Rate (/s) counter for ssltotdtlsv12clientauthentications.
		"""
		try :
			return self._ssldtlsv12clientauthenticationsrate
		except Exception as e:
			raise e
	...
	@property
	def sslcryptoutilizationasymstat(self) :
		r"""Utilization of the hardware asymmetric crypto resource. Only valid values are 0-100%. Only works on platforms with Intel crypto chips.
		"""
		try :
			return self._sslcryptoutilizationasymstat
		except Exception as e:
			raise e
	...
	@property
	def ssldtlsv12transactionsrate(self) :
		r"""Rate (/s) counter for ssltotdtlsv12transactions.
		"""
		try :
			return self._ssldtlsv12transactionsrate
		except Exception as e:
			raise e
	...
	@property
	def ssltotecdhetransactions(self) :
		r"""Total ECDHE Transactions on Citrix ADC.
		"""
		try :
			return self._ssltotecdhetransactions
		except Exception as e:
			raise e
