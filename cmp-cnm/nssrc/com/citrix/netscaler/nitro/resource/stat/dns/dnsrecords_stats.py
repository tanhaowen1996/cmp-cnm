...
class dnsrecords_stats(base_resource) :
	def __init__(self) :
		...
		self._dnstotqueryforexpiredrecord = 0
	...
	@property
	def dnstotqueryforexpiredrecord(self) :
		r"""Total number of times query was received for expired record.
		"""
		try :
			return self._dnstotqueryforexpiredrecord
		except Exception as e:
			raise e
