...
class appfwprofile_jsoncmdurl_binding(base_resource) :
	""" Binding class showing the jsoncmdurl that can be bound to appfwprofile.
	"""
	def __init__(self) :
		self._jsoncmdurl = None
		self._state = None
		self._comment = None
	...
	@property
	def jsoncmdurl(self) :
		r"""A regular expression that designates a URL on the Json CMD URL list for which Command injection violations are relaxed.
		...
		"""
		try :
			return self._jsoncmdurl
		except Exception as e:
			raise e

	@jsoncmdurl.setter
	def jsoncmdurl(self, jsoncmdurl) :
		r"""A regular expression that designates a URL on the Json CMD URL list for which Command injection violations are relaxed.
		Enclose URLs in double quotes to ensure preservation of any embedded spaces or non-alphanumeric characters.<br/>Minimum length =  1<br/>Maximum length =  2047
		"""
		try :
			self._jsoncmdurl = jsoncmdurl
		except Exception as e:
			raise e
	...
	def _get_nitro_response(self, service, response) :
		...
		"""
		try :
			result = service.payload_formatter.string_to_resource(appfwprofile_jsoncmdurl_binding_response, response, self.__class__.__name__)
			if(result.errorcode != 0) :
				...
				if result.severity :
					...
					raise nitro_exception(result.errorcode, str(result.message), str(result.severity))
			return result.appfwprofile_jsoncmdurl_binding
		except Exception as e :
			raise e
	...
	def filter_add_parameters(cls, resource) :
		...
		"""
		addresource = appfwprofile_jsoncmdurl_binding()
		addresource.name = resource.name
		addresource.comment = resource.comment
		addresource.state = resource.state
		addresource.jsoncmdurl = resource.jsoncmdurl
		...
		try :
			if resource and type(resource) is not list :
				...
				if resource and len(resource) > 0 :
					updateresources = [appfwprofile_jsoncmdurl_binding() for _ in range(len(resource))]
	...
	def filter_delete_parameters(cls, resource) :
		...
		"""
		deleteresource = appfwprofile_jsoncmdurl_binding()
		deleteresource.name = resource.name
		deleteresource.jsoncmdurl = resource.jsoncmdurl
	...
	def delete(cls, client, resource) :
		try :
			if resource and type(resource) is not list :
				...
				if resource and len(resource) > 0 :
					deleteresources = [appfwprofile_jsoncmdurl_binding() for _ in range(len(resource))]
					for i in range(len(resource)) :
	...
	def get(cls, service, name="", option_="") :
		r""" Use this API to fetch appfwprofile_jsoncmdurl_binding resources.
		"""
		try :
			if not name :
				obj = appfwprofile_jsoncmdurl_binding()
	...
	def get_filtered(cls, service, name, filter_) :
		r""" Use this API to fetch filtered set of appfwprofile_jsoncmdurl_binding resources.
	...
	def count(cls, service, name) :
		r""" Use this API to count appfwprofile_jsoncmdurl_binding resources configued on NetScaler.
		"""
		try :
			obj = appfwprofile_jsoncmdurl_binding()
			obj.name = name
	...
	def count_filtered(cls, service, name, filter_) :
		r""" Use this API to count the filtered set of appfwprofile_jsoncmdurl_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = appfwprofile_jsoncmdurl_binding()
...
class appfwprofile_jsoncmdurl_binding_response(base_response) :
	def __init__(self, length=1) :
		self.appfwprofile_jsoncmdurl_binding = []
		self.errorcode = 0
		self.message = ""
		self.severity = ""
		self.sessionid = ""
		self.appfwprofile_jsoncmdurl_binding = [appfwprofile_jsoncmdurl_binding() for _ in range(length)]
