...
class appflowaction(base_resource) :
	...
	@property
	def ciinsight(self) :
		r"""On enabling this option, the Citrix ADC will send the ContentInspection Insight records to the configured collectors.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
			return self._ciinsight
		except Exception as e:
			raise e

	@ciinsight.setter
	def ciinsight(self, ciinsight) :
		r"""On enabling this option, the Citrix ADC will send the ContentInspection Insight records to the configured collectors.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED
		"""
		try :
			self._ciinsight = ciinsight
		except Exception as e:
			raise e
	...
	def filter_add_parameters(cls, resource) :
		...
		addresource.ciinsight = resource.ciinsight
	...
	def filter_update_parameters(cls, resource) :
		...
		updateresource.ciinsight = resource.ciinsight
