...
class responderglobal_responderpolicy_binding(base_resource) :
	...
	class Type:
		...
		MQTT_REQ_OVERRIDE = "MQTT_REQ_OVERRIDE"
		MQTT_REQ_DEFAULT = "MQTT_REQ_DEFAULT"
		MQTT_JUMBO_REQ_OVERRIDE = "MQTT_JUMBO_REQ_OVERRIDE"
		MQTT_JUMBO_REQ_DEFAULT = "MQTT_JUMBO_REQ_DEFAULT"
		QUIC_OVERRIDE = "QUIC_OVERRIDE"
		QUIC_DEFAULT = "QUIC_DEFAULT"
