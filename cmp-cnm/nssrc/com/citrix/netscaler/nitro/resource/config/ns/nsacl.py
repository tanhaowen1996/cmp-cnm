...
class nsacl(base_resource) :
	...
	@property
	def srcipdataset(self) :
		r"""Policy dataset which can have multiple IP ranges bound to it.
		"""
		try :
			return self._srcipdataset
		except Exception as e:
			raise e

	@srcipdataset.setter
	def srcipdataset(self, srcipdataset) :
		r"""Policy dataset which can have multiple IP ranges bound to it.
		"""
		try :
			self._srcipdataset = srcipdataset
		except Exception as e:
			raise e
	...
	@property
	def destipdataset(self) :
		r"""Policy dataset which can have multiple IP ranges bound to it.
		"""
		try :
			return self._destipdataset
		except Exception as e:
			raise e

	@destipdataset.setter
	def destipdataset(self, destipdataset) :
		r"""Policy dataset which can have multiple IP ranges bound to it.
		"""
		try :
			self._destipdataset = destipdataset
		except Exception as e:
			raise e
	...
	def filter_add_parameters(cls, resource) :
		...
		addresource.srcipdataset = resource.srcipdataset
		...
		addresource.destipdataset = resource.destipdataset
