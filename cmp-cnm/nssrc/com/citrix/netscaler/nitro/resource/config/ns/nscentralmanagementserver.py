...
class nscentralmanagementserver(base_resource) :
	...
	def __init__(self) :
		...
		self._validatecert = None
		self._deviceprofilename = None
		self._adcusername = None
		self._adcpassword = None
		self._instanceid = None
		self._customerid = None
		self._admserviceenvironment = None
		self._admserviceconnectionstatus = None
		self.___count = None
	...
	def activationcode(self) :
		r"""Activation code is used to register to ADM service.<br/>Minimum length =  1<br/>Maximum length =  127.
		"""
		try :
	...
	@property
	def servername(self) :
		r"""Fully qualified domain name of the central management server or service-url to locate ADM service.
		"""
		try :
	...
	def validatecert(self) :
		r"""validate the server certificate for secure SSL connections.<br/>Default value: YES<br/>Possible values = YES, NO.
		"""
		try :
			return self._validatecert
		except Exception as e:
			raise e

	@validatecert.setter
	def validatecert(self, validatecert) :
		r"""validate the server certificate for secure SSL connections.<br/>Default value: YES<br/>Possible values = YES, NO
		"""
		try :
	...
	@property
	def deviceprofilename(self) :
		r"""Device profile is created on ADM and contains the user name and password of the instance(s).<br/>Minimum length =  1<br/>Maximum length =  255.
		"""
		try :
			return self._deviceprofilename
		except Exception as e:
			raise e

	@deviceprofilename.setter
	def deviceprofilename(self, deviceprofilename) :
		r"""Device profile is created on ADM and contains the user name and password of the instance(s).<br/>Minimum length =  1<br/>Maximum length =  255
		"""
		try :
			self._deviceprofilename = deviceprofilename
		except Exception as e:
			raise e

	@property
	def adcusername(self) :
		r"""ADC username used to create device profile on ADM.<br/>Minimum length =  1<br/>Maximum length =  127.
		"""
		try :
			return self._adcusername
		except Exception as e:
			raise e

	@adcusername.setter
	def adcusername(self, adcusername) :
		r"""ADC username used to create device profile on ADM.<br/>Minimum length =  1<br/>Maximum length =  127
		"""
		try :
			self._adcusername = adcusername
		except Exception as e:
			raise e

	@property
	def adcpassword(self) :
		r"""ADC password used to create device profile on ADM.<br/>Minimum length =  1<br/>Maximum length =  127.
		"""
		try :
			return self._adcpassword
		except Exception as e:
			raise e

	@adcpassword.setter
	def adcpassword(self, adcpassword) :
		r"""ADC password used to create device profile on ADM.<br/>Minimum length =  1<br/>Maximum length =  127
		"""
		try :
			self._adcpassword = adcpassword
		except Exception as e:
			raise e

	@property
	def instanceid(self) :
		r"""Instance ID of the customer provided by Trust.
		"""
		try :
	...
	@property
	def customerid(self) :
		r"""Customer ID of the citrix cloud customer.
		"""
		try :
	...
	@property
	def admserviceenvironment(self) :
		r"""ADM service environment (PRODUCTION/STAGING/DEV).<br/>Possible values = PRODUCTION, STAGING, DEV.
		"""
		try :
			return self._admserviceenvironment
		except Exception as e:
			raise e

	@property
	def admserviceconnectionstatus(self) :
		r"""Built-in agent's (mastools) connection status to ADM service.<br/>Possible values = CONNECTED, DISCONNECTED.
		"""
		try :
			return self._admserviceconnectionstatus
		except Exception as e:
			raise e
	...
	def filter_add_parameters(cls, resource) :
		...
		addresource.activationcode = resource.activationcode
		addresource.ipaddress = resource.ipaddress
		addresource.servername = resource.servername
		addresource.validatecert = resource.validatecert
		addresource.deviceprofilename = resource.deviceprofilename
		addresource.adcusername = resource.adcusername
		addresource.adcpassword = resource.adcpassword
		return addresource
	...
	class Admserviceconnectionstatus:
		CONNECTED = "CONNECTED"
		DISCONNECTED = "DISCONNECTED"

	class Admserviceenvironment:
