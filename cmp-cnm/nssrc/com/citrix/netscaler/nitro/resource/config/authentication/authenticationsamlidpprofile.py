...
class authenticationsamlidpprofile(base_resource) :
	...
	def serviceproviderid(self) :
		r"""Unique identifier of the Service Provider that sends SAML Request. Citrix ADC will ensure that the Issuer of the SAML Request matches this URI. In case of SP initiated sign-in scenarios, this value must be same as samlIssuerName configured in samlAction.<br/>Minimum length =  1.
		"""
		try :
	...
	def defaultauthenticationgroup(self) :
		r"""This group will be part of AAA session's internal group list. This will be helpful to admin in Nfactor flow to decide right AAA configuration for Relaying Party. In authentication policy AAA.USER.IS_MEMBER_OF("<default_auth_group>")  is way to use this feature.
		"""
		try :
	...
	@property
	def acsurlrule(self) :
		r"""Expression that will be evaluated to allow Assertion Consumer Service URI coming in the SAML Request.<br/>Maximum length =  8191.
		"""
		try :
			return self._acsurlrule
		except Exception as e:
			raise e

	@acsurlrule.setter
	def acsurlrule(self, acsurlrule) :
		r"""Expression that will be evaluated to allow Assertion Consumer Service URI coming in the SAML Request.<br/>Maximum length =  8191
		"""
		try :
			self._acsurlrule = acsurlrule
		except Exception as e:
			raise e
	...
	def filter_add_parameters(cls, resource) :
		...
		addresource.acsurlrule = resource.acsurlrule
		return addresource
	...
	def filter_update_parameters(cls, resource) :
		...
		updateresource.acsurlrule = resource.acsurlrule
