...
class csvserver(base_resource) :
	...
	def servicetype(self) :
		r"""Protocol used by the virtual server.<br/>Possible values = HTTP, SSL, TCP, FTP, RTSP, SSL_TCP, UDP, DNS, SIP_UDP, SIP_TCP, SIP_SSL, ANY, RADIUS, RDP, MYSQL, MSSQL, DIAMETER, SSL_DIAMETER, DNS_TCP, ORACLE, SMPP, PROXY, MONGO, MONGO_TLS, MQTT, MQTT_TLS, HTTP_QUIC.
		"""
		try :
	...
	@property
	def dtls(self) :
		r"""This option starts/stops the dtls service on the vserver.<br/>Default value: OFF<br/>Possible values = ON, OFF.
		"""
		try :
			return self._dtls
		except Exception as e:
	...
	def quicprofilename(self) :
		r"""Name of QUIC profile which will be attached to the Content Switching VServer.<br/>Minimum length =  1<br/>Maximum length =  255.
		"""
		try :
	...
	@property
	def bindpoint(self) :
		r"""The bindpoint to which the policy is bound.<br/>Possible values = REQUEST, RESPONSE, ICA_REQUEST, OTHERTCP_REQUEST, MQTT_JUMBO_REQ.
		"""
		try :
