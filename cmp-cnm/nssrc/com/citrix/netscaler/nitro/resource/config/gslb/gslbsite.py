...
class gslbsite(base_resource) :
	...
	@property
	def sitestate(self) :
		r"""Site  state.<br/>Possible values = UP, DOWN, UNKNOWN, BUSY, OUT OF SERVICE, GOING OUT OF SERVICE, DOWN WHEN GOING OUT OF SERVICE, NS_EMPTY_STR, Unknown, DISABLED.
		"""
		try :
			return self._sitestate
		except Exception as e:
			raise e
