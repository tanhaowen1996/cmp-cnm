...
class sslpolicylabel(base_resource) :
	...
	@property
	def type(self) :
		r"""Type of policies that the policy label can contain.<br/>Possible values = CONTROL, DATA, HTTPQUIC_CONTROL, HTTPQUIC_DATA.
		"""
		try :
			return self._type
		except Exception as e:
	...
	class Type:
		CONTROL = "CONTROL"
		DATA = "DATA"
		HTTPQUIC_CONTROL = "HTTPQUIC_CONTROL"
		HTTPQUIC_DATA = "HTTPQUIC_DATA"
