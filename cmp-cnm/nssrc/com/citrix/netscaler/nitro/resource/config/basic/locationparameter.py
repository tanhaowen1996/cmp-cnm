...
class locationparameter(base_resource) :
	...
	def matchwildcardtoany(self) :
		r"""Indicates whether wildcard qualifiers should match any other
		...
		non-wildcard qualifiers in an expression.<br/>Default value: NO<br/>Possible values = YES, NO, Expression.
		"""
		try :
	...
	@matchwildcardtoany.setter
	def matchwildcardtoany(self, matchwildcardtoany) :
		r"""Indicates whether wildcard qualifiers should match any other
		qualifier including non-wildcard while evaluating
		location based expressions.
		Possible values: Yes, No, Expression.
		...
		"""
		try :
			self._matchwildcardtoany = matchwildcardtoany
		except Exception as e:
			raise e
	...
	def filter_update_parameters(cls, resource) :
		...
		updateresource.matchwildcardtoany = resource.matchwildcardtoany
